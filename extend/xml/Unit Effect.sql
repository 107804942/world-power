...
-----更新单位需求科技
UPDATE Units SET ObsoleteTech = 'TECH_LIQUIDMETAL' WHERE Class  = 'UNITCLASS_MILITIA_MODERN'; ----民兵
UPDATE Units SET ObsoleteTech = 'TECH_HOMO_SUPERIOR' WHERE Class  = 'UNITCLASS_MECHANIZED_INFANTRY'; ----机械化步兵，盖里欧机甲
UPDATE Units SET ObsoleteTech = 'TECH_AUTONOMOUS_SYSTEMS' WHERE Class  = 'UNITCLASS_MODERN_ARMOR'; ----现代装甲，重型机甲
UPDATE Units SET ObsoleteTech = 'TECH_NANOTECHNOLOGY' WHERE Class  = 'UNITCLASS_ATGM_VEHICLE'; ----反坦克导弹，悬浮穿甲炮
UPDATE Units SET ObsoleteTech = 'TECH_HOMO_SUPERIOR' WHERE Class  = 'UNITCLASS_ROCKET_ARTILLERY'; ----火箭炮，多管能量炮		
UPDATE Units SET ObsoleteTech = 'TECH_HOMO_SUPERIOR' WHERE Class  = 'UNITCLASS_SELF_PROPELLED_ARTILLERY'; ----攻城炮，悬浮攻城炮			
UPDATE Units SET ObsoleteTech = 'TECH_HOMO_SUPERIOR' WHERE Class  = 'UNITCLASS_SAM_INFANTRY'; ----防空炮，重炮平台
UPDATE Units SET ObsoleteTech = 'TECH_INTERSTELLAR_TRAVEL' WHERE Class  = 'UNITCLASS_ATTACK_HELICOPTER'; ----武装直升机，喷气式直升机

UPDATE Units SET ObsoleteTech = 'TECH_MECHANICAL_ENGINEERING' WHERE Class  = 'UNITCLASS_MODERN_DESTROYER'; ----现代驱逐舰
UPDATE Units SET ObsoleteTech = 'TECH_MECHANICAL_ENGINEERING' WHERE Class  = 'UNITCLASS_SSBN'; ----导弹核潜艇
UPDATE Units SET ObsoleteTech = 'TECH_MECHANICAL_ENGINEERING' WHERE Class  = 'UNITCLASS_MISSILE_CRUISER'; ----导弹巡洋舰
UPDATE Units SET ObsoleteTech = 'TECH_MECHANICAL_ENGINEERING' WHERE Class  = 'UNITCLASS_FUTURE_BATTLESHIP'; ----武库舰
UPDATE Units SET ObsoleteTech = 'TECH_MECHANICAL_ENGINEERING' WHERE Class  = 'UNITCLASS_SUPER_CARRIER'; ----超级核动力航母
UPDATE Units SET ObsoleteTech = 'TECH_MECHANICAL_ENGINEERING' WHERE Type  = 'UNIT_AMERICAN_NIMITZ'; ----尼米兹


UPDATE Units SET ObsoleteTech = 'TECH_SPACE_TECHNOLOGY' WHERE Class  = 'UNITCLASS_GUIDED_MISSILE'; ----导弹
UPDATE Units SET ObsoleteTech = 'TECH_INTERSTELLAR_TRAVEL' WHERE Class  = 'UNITCLASS_CARRIER_FIGHTER_ADV'; ----舰载机
UPDATE Units SET ObsoleteTech = 'TECH_INTERSTELLAR_TRAVEL' WHERE Class  = 'UNITCLASS_JET_FIGHTER'; ----战斗机
UPDATE Units SET ObsoleteTech = 'TECH_INTERSTELLAR_TRAVEL' WHERE Class  = 'UNITCLASS_STEALTH_BOMBER'; ----隐形轰炸机
UPDATE Units SET ObsoleteTech = 'TECH_INTERSTELLAR_TRAVEL' WHERE Class  = 'UNITCLASS_STEALTH_ATTACK_AIRCRAFT'; ----隐形歼击机
UPDATE Units SET ObsoleteTech = 'TECH_INTERSTELLAR_TRAVEL' WHERE Class  = 'UNITCLASS_PAKFA_T50'; ----yf23战斗机

UPDATE Units SET PrereqTech = 'TECH_EARTH' WHERE Type  = 'UNIT_SATELLITE_ORBITAL_STRIKE'; ----上帝之杖
UPDATE Units SET PrereqTech = 'TECH_SPACE_TECHNOLOGY',Combat=200 WHERE Class  = 'UNITCLASS_XCOM_SQUAD'; ----XCOM
UPDATE Units SET PrereqTech = 'TECH_CHEMISTRY' WHERE Type  = 'UNIT_FRENCH_MUSKETEER'; ----法火
UPDATE Units SET ObsoleteTech = 'TECH_INTERSTELLAR_TRAVEL' WHERE Class  = 'UNITCLASS_STEALTH_HELICOPTER'; ---科曼奇
UPDATE Units SET ObsoleteTech = 'TECH_HOMO_SUPERIOR' WHERE Class  = 'UNITCLASS_CRUSADER_ARTILLERY';  ----十字军火炮
UPDATE Units SET ObsoleteTech = 'TECH_HOMO_SUPERIOR' WHERE Class  = 'UNITCLASS_CHINESE_WEISHI';   ----卫士
UPDATE Units SET PrereqTech = 'TECH_INTERSTELLAR_TRAVEL' WHERE Type  = 'UNIT_SATELLITE_ECCM'; 
UPDATE Units SET PrereqTech = 'TECH_WAVEMECHANICS' WHERE Type  = 'UNIT_SATELLITE_RESOURCEPLUS'; 
UPDATE Units SET PrereqTech = 'TECH_ARTIFICIAL_INTELLIGENCE' WHERE Type  = 'UNIT_SATELLITE_SPACE_ELEVATOR'; 
UPDATE Units SET PrereqTech = 'TECH_CARTOGRAPHY' ,ObsoleteTech = 'TECH_NAUTICAL_SCIENCE' WHERE Class  = 'UNITCLASS_GREAT_GALLEASS';
UPDATE Units SET PrereqTech = 'TECH_ROBOTICS' ,ObsoleteTech = 'TECH_HOMO_SUPERIOR' WHERE Class  = 'UNITCLASS_LITTORAL_COMBAT_SHIP';
...
-----工人可购买
UPDATE Units SET PuppetPurchaseOverride = 1 WHERE Class  = 'UNITCLASS_WORKER';
...
('UNIT_ELITE_BATTLECRUISER','UNITCLASS_NAVALFIGHTER04S'),
('UNIT_STURMTIGER','UNITCLASS_HOVERTANK'),
('UNIT_P1500','UNITCLASS_AEGIS'),
('UNIT_SUPER_BATTLESHIP','UNITCLASS_NAVALFIGHTER03P'), 
--('UNIT_UNDERWATER_CARRIER','UNITCLASS_NAVALFIGHTER04P'),
('UNIT_CHINESE_WEISHI','UNITCLASS_SUPER_ROCKET'),
--('UNIT_TASKFORCE_141','UNITCLASS_XCOM_SQUAD'),
('UNIT_STEALTH_HELICOPTER','UNITCLASS_VERTOL'),
('UNIT_CRUSADER_ARTILLERY','UNITCLASS_HOVERTANK'),
('UNIT_PAKFA_T50','UNITCLASS_AIRFIGHTER03P');


-----科技提升战斗力

INSERT INTO Unit_TechCombatStrength (UnitType, 	TechType,	CombatStrength) VALUES	 		
('UNIT_MECH',		'TECH_CYBERNETICS', 1500);
...
INSERT  INTO UnitPromotions_UnitCombats(PromotionType,UnitCombatType)
SELECT  'PROMOTION_ROYAL', Type FROM UnitCombatInfos WHERE Type= 'UNITCOMBAT_SUBMARINE'OR Type= 'UNITCOMBAT_NAVALMELEE'OR Type= 'UNITCOMBAT_NAVALRANGED' OR Type= 'UNITCOMBAT_CARRIER';
...
INSERT  INTO UnitPromotions_UnitCombats(PromotionType,UnitCombatType)
SELECT  'PROMOTION_KGB', Type FROM UnitCombatInfos WHERE Type!= 'UNITCOMBAT_SUBMARINE'AND Type!= 'UNITCOMBAT_NAVALMELEE'AND Type!= 'UNITCOMBAT_NAVALRANGED' AND Type!= 'UNITCOMBAT_CARRIER' AND Type!= 'UNITCOMBAT_FIGHTER'AND Type!= 'UNITCOMBAT_ARCHER' AND Type!= 'UNITCOMBAT_WORKER' AND Type!= 'UNITCOMBAT_SETTLER';
...
--桨帆船
 INSERT  INTO Unit_ResourceQuantityRequirements(UnitType, ResourceType, Cost)
 SELECT Type, 'RESOURCE_LUMBER',1 FROM Units WHERE Class='UNITCLASS_NAVAL_MILITIA';

CREATE TRIGGER CostForNAVALMILITIA
AFTER INSERT ON Units
WHEN 'UNITCLASS_NAVAL_MILITIA'=NEW.Class
BEGIN
  INSERT INTO Unit_ResourceQuantityRequirements(UnitType, ResourceType, Cost)
    VALUES(NEW.Type, 'RESOURCE_LUMBER',1);
END;
...
-- 炮艇
INSERT INTO Unit_ResourceQuantityRequirements (UnitType, ResourceType,Cost )
SELECT Type, 'RESOURCE_GUNPOWDER',1 FROM Units WHERE Class='UNITCLASS_MONITOR_SHIP';

CREATE TRIGGER CostForMONITORSHIP
AFTER INSERT ON Units
WHEN 'UNITCLASS_MONITOR_SHIP'=NEW.Class
BEGIN
  INSERT INTO Unit_ResourceQuantityRequirements(UnitType, ResourceType, Cost)
    VALUES(NEW.Type, 'RESOURCE_GUNPOWDER',1);
END;
...
-- 护卫舰
INSERT INTO Unit_ResourceQuantityRequirements (UnitType, ResourceType,Cost )
SELECT Type, 'RESOURCE_GUNPOWDER',1 FROM Units WHERE Class='UNITCLASS_CORVETTE';

CREATE TRIGGER CostForCORVETTE
AFTER INSERT ON Units
...
-- 滨海战斗舰
INSERT INTO Unit_ResourceQuantityRequirements (UnitType, ResourceType,Cost )
SELECT Type, 'RESOURCE_GUNPOWDER',1 FROM Units WHERE Class='UNITCLASS_LITTORAL_COMBAT_SHIP';

CREATE TRIGGER CostForLITTORALCOMBATSHIP
AFTER INSERT ON Units
WHEN 'UNITCLASS_LITTORAL_COMBAT_SHIP'=NEW.Class
BEGIN
  INSERT INTO Unit_ResourceQuantityRequirements(UnitType, ResourceType, Cost)
    VALUES(NEW.Type, 'RESOURCE_GUNPOWDER',1);
END;
...
--潜艇
INSERT INTO Unit_ClassUpgrades(UnitType, UnitClassType)
SELECT Type, 'UNITCLASS_SUB04S' FROM Units WHERE Class='UNITCLASS_SSBN';
...
INSERT INTO UnitPromotions 
			(Type, 													Description, 										Help, 														Sound, 		CannotBeChosen,		PortraitIndex,		IconAtlas, 			 			PediaEntry,  PediaType ,ShowInPedia,ShowInUnitPanel, CargoChange, RemoveAfterXTurns)
VALUES	    ('PROMOTION_SPACE_BATTLECRUISER_MANA', 	    'TXT_KEY_PROMOTION_SPACE_BATTLECRUISER_MANA', 'TXT_KEY_PROMOTION_SPACE_BATTLECRUISER_MANA_HELP',   'AS2D_IF_LEVELUP',		1,					22,			'MainRobotPromo_Atlas', 	 'TXT_KEY_PROMOTION_SPACE_BATTLECRUISER_MANA',         'PEDIA_ATTRIBUTES'        ,0  , 1,  10,0 ),
			('PROMOTION_SPACE_BATTLECRUISER_MANA_COLD_DOWN', 	'TXT_KEY_PROMOTION_SPACE_BATTLECRUISER_MANA_COLD_DOWN', 'TXT_KEY_PROMOTION_SPACE_BATTLECRUISER_MANA_COLD_DOWN_HELP', 'AS2D_IF_LEVELUP',		1,					22,			'MainRobotPromo_Atlas', 	 'TXT_KEY_PROMOTION_SPACE_BATTLECRUISER_MANA_COLD_DOWN',         'PEDIA_ATTRIBUTES'        ,0  ,0 ,  0,3 ),
			('PROMOTION_SPACE_BATTLECRUISER_NUKE_COLD_DOWN', 	'TXT_KEY_PROMOTION_SPACE_BATTLECRUISER_NUKE_COLD_DOWN', 'TXT_KEY_PROMOTION_SPACE_BATTLECRUISER_NUKE_COLD_DOWN_HELP', 'AS2D_IF_LEVELUP',		1,					22,			'MainRobotPromo_Atlas', 	 'TXT_KEY_PROMOTION_SPACE_BATTLECRUISER_NUKE_COLD_DOWN',         'PEDIA_ATTRIBUTES'        ,0  ,0 ,  0,1 );
