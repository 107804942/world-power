...
INSERT INTO Building_BuildingClassYieldModifiers(BuildingType, BuildingClassType,YieldType,Modifier) VALUES  
     ('BUILDING_CITADEL_OF_CARCASSONNE', 'BUILDINGCLASS_CASTLE', 'YIELD_CRIME',-3),
      ('BUILDING_CITADEL_OF_CARCASSONNE', 'BUILDINGCLASS_EE_BASTION', 'YIELD_CRIME',-3),
...
SELECT 'BUILDINGCLASS_PALACE',		  -35 UNION ALL
SELECT 'BUILDINGCLASS_CITY_HALL_LV1', -25 UNION ALL    --一级
SELECT 'BUILDINGCLASS_CITY_HALL_LV2', -15 UNION ALL	--二级
...
SELECT 'BUILDINGCLASS_PALACE',			        -15 UNION ALL
SELECT 'BUILDINGCLASS_CITY_HALL_LV1',			-10 UNION ALL
SELECT 'BUILDINGCLASS_CITY_HALL_LV2',			-5 UNION ALL
SELECT 'BUILDINGCLASS_CITY_HALL_LV3',			3 UNION ALL
SELECT 'BUILDINGCLASS_CITY_HALL_LV4',			5 UNION ALL
...
UPDATE LocalizedText
	SET Text = Text||'[NEWLINE][NEWLINE][ICON_BULLET]-10[ICON_CRIME]犯罪率,-25%[ICON_CRIME]犯罪率。'
	WHERE Tag IN (SELECT Help FROM Buildings WHERE BuildingClass = 'BUILDINGCLASS_CITY_HALL_LV1');

UPDATE LocalizedText
	SET Text = Text||'[NEWLINE][NEWLINE][ICON_BULLET]-5[ICON_CRIME]犯罪率,-15%[ICON_CRIME]犯罪率。'
	WHERE Tag IN (SELECT Help FROM Buildings WHERE BuildingClass = 'BUILDINGCLASS_CITY_HALL_LV2');

UPDATE LocalizedText
	SET Text = Text||'[NEWLINE][NEWLINE][ICON_BULLET]+3[ICON_CRIME]犯罪率。'
	WHERE Tag IN (SELECT Help FROM Buildings WHERE BuildingClass = 'BUILDINGCLASS_CITY_HALL_LV3');

UPDATE LocalizedText
	SET Text = Text||'[NEWLINE][NEWLINE][ICON_BULLET]+5[ICON_CRIME]犯罪率,+25%[ICON_CRIME]犯罪率。'
