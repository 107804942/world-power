...
SELECT 'BUILDINGCLASS_CLOACA',					            3 UNION ALL		--下水道
SELECT 'BUILDINGCLASS_BALNEAE',					            3 UNION ALL		--公共浴室
...
SELECT 'BUILDINGCLASS_BATHS',			                8 UNION ALL	    --大浴场  
SELECT 'BUILDINGCLASS_MEDICAL_COMPANY',						12 UNION ALL     --医药公司
...
SELECT 'BUILDINGCLASS_BATHS',					                 15 UNION ALL    --大浴场
SELECT 'BUILDINGCLASS_PONTDUGARD',					             15 UNION ALL    --加尔桥
...
('BUILDING_PONTDUGARD', 'IMPROVEMENT_FARM', 'YIELD_HEALTH',1),
('BUILDING_PONTDUGARD', 'IMPROVEMENT_SAND_BASE', 'YIELD_HEALTH',1),
('BUILDING_BATHS', 'IMPROVEMENT_TRADING_POST', 'YIELD_GOLD',1),
('BUILDING_BATHS', 'IMPROVEMENT_LARGE_TOWN', 'YIELD_GOLD',1),
('BUILDING_BATHS', 'IMPROVEMENT_TOWN', 'YIELD_GOLD',1),
('BUILDING_BATHS', 'IMPROVEMENT_TRADING_POST', 'YIELD_HEALTH',1),
('BUILDING_BATHS', 'IMPROVEMENT_LARGE_TOWN', 'YIELD_HEALTH',1),
('BUILDING_BATHS', 'IMPROVEMENT_TOWN', 'YIELD_HEALTH',1);
...
SELECT     'BUILDING_BATHS',	        	         'YIELD_CULTURE',	  25 UNION ALL
SELECT     'BUILDING_BATHS',	        	         'YIELD_HEALTH',	  25 UNION ALL
SELECT     'BUILDING_PONTDUGARD',	                     'YIELD_HEALTH',	  25 ;

---建筑与河流产出
INSERT INTO Building_RiverPlotYieldChanges(BuildingType,	YieldType,	  Yield)
SELECT     'BUILDING_PONTDUGARD',	        'YIELD_HEALTH',	  1 UNION ALL
...
SELECT 'BUILDING_MEROE', 'TERRAIN_DESERT', 'YIELD_HEALTH',1 ;
  

---建筑与地貌产出
INSERT INTO Building_FeatureYieldChanges (BuildingType,	FeatureType,			YieldType,		Yield)
SELECT     'BUILDING_MEROE', 'FEATURE_OASIS',  'YIELD_HEALTH', 1 UNION ALL
...
--SELECT     'BUILDING_BIOLOGICAL_FACTORIES',	'BUILDINGCLASS_HOSPITAL',	                    'YIELD_HEALTH',	  3 UNION ALL
--SELECT     'BUILDING_BIOLOGICAL_FACTORIES',	'BUILDINGCLASS_BIO_LAB',	                    'YIELD_HEALTH',	  3 UNION ALL
SELECT     'BUILDING_BATHS',	'BUILDINGCLASS_BALNEAE',	                'YIELD_CULTURE',	  3 UNION ALL
SELECT     'BUILDING_BATHS',	'BUILDINGCLASS_BALNEAE',	                'YIELD_HEALTH',	  3 UNION ALL
