...
UnitEVACButton = {
  ...
  Condition = function(action, unit)
    return unit:CanMove() 
	and (unit:GetUnitType() == GameInfoTypes.UNIT_TASKFORCE_141 or unit:GetUnitType() == GameInfoTypes.UNIT_GHOST) 
...
LuaEvents.UnitPanelActionAddin(UnitRiotControlButton2);
