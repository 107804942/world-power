...
SELECT 'BUILDINGCLASS_CITY_HALL_LV1', -25 UNION ALL    --小城市
SELECT 'BUILDINGCLASS_CITY_HALL_LV2', -15 UNION ALL	--中城市
SELECT 'BUILDINGCLASS_CITY_HALL_LV3',-5 UNION ALL	--大城市
SELECT 'BUILDINGCLASS_CITY_HALL_LV4',25 UNION ALL    --特大城市
SELECT 'BUILDINGCLASS_CITY_HALL_LV5',40 UNION ALL	--巨型城市
...
SELECT 'BUILDINGCLASS_OSARAGI',					-10 UNION ALL   --高德院
SELECT 'BUILDINGCLASS_DUNGEON',					-5 UNION ALL   --地牢
SELECT 'BUILDINGCLASS_CONSTABLE',				-5 UNION ALL   --治安署
...
SELECT 'BUILDINGCLASS_KGB',			             -15 UNION ALL   --克格勃
SELECT 'BUILDINGCLASS_INTELLIGENCE_BUREAU',		-10 UNION ALL   --情报局
SELECT 'BUILDINGCLASS_PROCURATORATE',		-10 UNION ALL   --地检署

SELECT 'BUILDINGCLASS_GRANARY',				     2 UNION ALL   --粮仓
...
SELECT 'BUILDINGCLASS_SKYNET',				    -20 UNION ALL     --天网
...
SELECT 'BUILDINGCLASS_CITY_HALL_LV3',			5 UNION ALL
