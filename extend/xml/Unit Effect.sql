...
('UNIT_UNDERWATER_CARRIER',		'TECH_CYBERNETICS', 580),
('UNIT_UNDERWATER_CRUSADER_ARTILLERY',		'TECH_MECHANICAL_ENGINEERING', 360),
('UNIT_CHINESE_WEISHI',		'TECH_HOMO_SUPERIOR', 100),	
('UNIT_TASKFORCE_141',		'TECH_GRID_COMPUTING',200),	 
('UNIT_STEALTH_HELICOPTER',		'TECH_ORBITAL_SUSPENSION',300), 		
...
('UNIT_UNDERWATER_CARRIER',		'TECH_CYBERNETICS', 480),	
('UNIT_UNDERWATER_CRUSADER_ARTILLERY',		'TECH_MECHANICAL_ENGINEERING', 360),	
('UNIT_CHINESE_WEISHI',		'TECH_HOMO_SUPERIOR',500),
('UNIT_PAKFA_T50',		'TECH_SPACE_COLONIZATION',660),	
('UNIT_STEALTH_HELICOPTER',		'TECH_ORBITAL_SUSPENSION',270),	
('UNIT_MECH',		'TECH_NEURAL_INTERFACE', 1500);
...
INSERT  INTO UnitPromotions_UnitType(PromotionType,UnitType)
SELECT 'PROMOTION_EHOVER', Type  FROM Units WHERE Class ='UNITCLASS_HOVERTANK';
