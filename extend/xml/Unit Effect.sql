...
UPDATE Units SET PrereqTech = 'TECH_ROBOTICS' ,ObsoleteTech = 'TECH_GRID_COMPUTING' WHERE Class  = 'UNITCLASS_LITTORAL_COMBAT_SHIP';

--UPDATE Units SET ObsoleteTech = 'TECH_CYBERNETICS' WHERE Class  = 'UNITCLASS_UNDERWATER_CARRIER';
UPDATE Units SET ObsoleteTech = 'TECH_HOMO_SUPERIOR' WHERE Class  = 'UNITCLASS_CHINESE_WEISHI';
--UPDATE Units SET ObsoleteTech = 'TECH_GRID_COMPUTING' WHERE Class  = 'UNITCLASS_TASKFORCE_141';
UPDATE Units SET ObsoleteTech = 'TECH_ORBITAL_SUSPENSION' WHERE Class  = 'UNITCLASS_STEALTH_HELICOPTER';
UPDATE Units SET ObsoleteTech = 'TECH_MECHANICAL_ENGINEERING' WHERE Class  = 'UNITCLASS_CRUSADER_ARTILLERY';
UPDATE Units SET ObsoleteTech = 'TECH_SPACE_COLONIZATION' WHERE Class  = 'UNITCLASS_PAKFA_T50';
...
SELECT 'TECH_SPACE_COLONIZATION', 'PROMOTION_XCOM_WEAPON_BASE' UNION ALL
