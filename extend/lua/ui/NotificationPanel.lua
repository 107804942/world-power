...
function OnNotificationAdded( Id, type, toolTip, strSummary, iGameValue, iExtraGameData, ePlayer )
    ...
    if (type == NotificationTypes.NOTIFICATION_PROJECT_COMPLETED and GameInfoTypes["PROJECT_COMMOM_ORGANIZED"] ~= nil and iGameValue == GameInfoTypes["PROJECT_COMMOM_ORGANIZED"])  ---ÐÂÔö
    then
        return;
    end
