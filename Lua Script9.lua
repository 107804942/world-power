-- Lua Script9
-- Author: 11585
-- DateCreated: 2023/11/5 19:53:17
--------------------------------------------------------------
...
------------------------------新---------------
		...
		elseif resourceType == "RESOURCE_FLAX" then	-- MOD.Barathor: New
			self.flax_ID = resourceID;
		elseif resourceType == "RESOURCE_LUMBER" then	-- MOD.Barathor: New
			self.lumber_ID = resourceID;
		elseif resourceType == "RESOURCE_RASPBERRYZ" then	-- MOD.Barathor: New
		...
		elseif resourceType == "RESOURCE_SANPEDRO" then	-- MOD.Barathor: New
			self.sanpendro_ID = resourceID;
		elseif resourceType == "RESOURCE_TEQUILA" then	-- MOD.Barathor: New
			self.tequila_ID = resourceID;
...
function AssignStartingPlots:GenerateNaturalWondersCandidatePlotLists()
	...
	for row in GameInfo.Features() do
		if (row.NaturalWonder == true  or row.PseudoNaturalWonder == 1) then  --新
...
function AssignStartingPlots:GetMajorStrategicResourceQuantityValues()
	...
	if self.resource_setting == 1 then -- Sparse
		uran_amt, horse_amt, oil_amt, iron_amt, coal_amt, alum_amt ,titanium_amt= 4, 4, 5, 4, 5, 5, 5;
	elseif self.resource_setting == 3 then -- Abundant
		uran_amt, horse_amt, oil_amt, iron_amt, coal_amt, alum_amt ,titanium_amt= 6, 6, 9, 10, 10, 10, 10;
	end
	return uran_amt, horse_amt, oil_amt, iron_amt, coal_amt, alum_amt,titanium_amt
end
------------------------------------------------------------------------------
function AssignStartingPlots:GetSmallStrategicResourceQuantityValues()
	...
	-- Check the resource setting.
	if self.resource_setting == 1 then -- Sparse
		uran_amt, horse_amt, oil_amt, iron_amt, coal_amt, alum_amt,titanium_amt = 2, 2, 2, 3, 4, 4, 4;
	elseif self.resource_setting == 3 then -- Abundant
		uran_amt, horse_amt, oil_amt, iron_amt, coal_amt, alum_amt ,titanium_amt= 4, 4, 6, 8, 8, 8, 8;
	end
	return uran_amt, horse_amt, oil_amt, iron_amt, coal_amt, alum_amt,titanium_amt
end
------------------------------------------------------------------------------
