...
VALUES	    ('PROMOTION_SPACE_BATTLECRUISER_MANA', 	    'TXT_KEY_PROMOTION_SPACE_BATTLECRUISER_MANA', 'TXT_KEY_PROMOTION_SPACE_BATTLECRUISER_MANA_HELP',   'AS2D_IF_LEVELUP',		1,					22,			'MainRobotPromo_Atlas', 	 'TXT_KEY_PROMOTION_SPACE_BATTLECRUISER_MANA',         'PEDIA_ATTRIBUTES'        ,0  , 1,  10,0 ),
			('PROMOTION_SPACE_BATTLECRUISER_MANA_COLD_DOWN', 	'TXT_KEY_PROMOTION_SPACE_BATTLECRUISER_MANA_COLD_DOWN', 'TXT_KEY_PROMOTION_SPACE_BATTLECRUISER_MANA_COLD_DOWN_HELP', 'AS2D_IF_LEVELUP',		1,					22,			'MainRobotPromo_Atlas', 	 'TXT_KEY_PROMOTION_SPACE_BATTLECRUISER_COLD_DOWN',         'PEDIA_ATTRIBUTES'        ,0  ,0 ,  0,3 );
