...
SELECT 'BUILDINGCLASS_COOKED_MEDICINE',						    50 UNION ALL  ---熟药所
SELECT 'BUILDINGCLASS_FACTORY',									-15 UNION ALL  --工厂
SELECT 'BUILDINGCLASS_NUCLEAR_PLANT',							-20 UNION ALL  --核电站
...
SELECT 'BUILDINGCLASS_INDUSTRIAL_ZONE',					        -30 UNION ALL --鲁尔工业区
