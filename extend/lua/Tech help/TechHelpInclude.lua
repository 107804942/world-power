...
function GetHelpTextForTech( iTechID )
	...
	if thisTech.MapVisible then
		...
		abilitiesString = abilitiesString .. Locale.ConvertTextKey( "TXT_KEY_CITY_BOMBARDMENT_MOD");
		numAbilities = numAbilities + 1;
	end


		--if thisTech.BombardQuickly > 0 then
		--if numAbilities > 0 then
			--abilitiesString = abilitiesString .. "[NEWLINE] [ICON_BULLET] ";
		---end
		--abilitiesString = abilitiesString .. Locale.ConvertTextKey( "TXT_KEY_CITY_BOMB_HELP");
		--numAbilities = numAbilities + 1;
	--end
