...
SELECT 'BELIEF_HEALTH_VAPORS',						'FEATURE_FLOOD_PLAINS',		'YIELD_GOLD',	2 UNION ALL
SELECT 'BELIEF_HEALTH_VAPORS',						'FEATURE_MARSH',		'YIELD_GOLD',	2 UNION ALL
SELECT 'BELIEF_HEALTH_VAPORS',						'FEATURE_FLOOD_PLAINS',		'YIELD_SCIENCE',	2 UNION ALL
SELECT 'BELIEF_HEALTH_VAPORS',						'FEATURE_MARSH',		'YIELD_SCIENCE',	2 UNION ALL
SELECT 'BELIEF_HEALTH_VAPORS',						'FEATURE_MARSH',		'YIELD_HEALTH',	2 UNION ALL
SELECT 'BELIEF_HEALTH_VAPORS',						'FEATURE_FLOOD_PLAINS',	'YIELD_HEALTH',	2;

INSERT INTO Belief_BuildingClassYieldChanges (BeliefType,	BuildingClassType,		YieldType,		YieldChange)
SELECT 'BELIEF_HEALTH_VAPORS',							'BUILDINGCLASS_BALNEAE',	'YIELD_GOLD',	2 UNION ALL
SELECT 'BELIEF_HEALTH_VAPORS',							'BUILDINGCLASS_BALNEAE',	'YIELD_FAITH',	2 UNION ALL
SELECT 'BELIEF_HEALTH_VAPORS',							'BUILDINGCLASS_BALNEAE',	'YIELD_SCIENCE',2 UNION ALL
SELECT 'BELIEF_HEALTH_VAPORS',							'BUILDINGCLASS_BALNEAE',	'YIELD_HEALTH',	2 UNION ALL
